...
GW_Vulkan_GLFW_Example::GW_Vulkan_GLFW_Example()
{
...
//GameLoop here for this wrapper
void GW_Vulkan_GLFW_Example::Run()
{
    LOGGING("GraphicsWrapper_Vulkan_GLFW Run called.")

        glfwSetErrorCallback(glfw_error_callback);
    if (!glfwInit())
        throw std::runtime_error("Failed to initialize GLFW"); // TODO: ADD TO DEBUG.H
    ...
    if (!glfwVulkanSupported())
    {
        ...
        throw std::runtime_error("Vulkan Not Supported"); // TODO: ADD TO DEBUG.H
    }
